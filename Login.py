...
puts ''
puts "Created By {n #{'Cinder'.red} :: #{'Automata'.blue} => https://www.facebook.com/cinderautomata nThanks For Refrence: n #{'Denny Darmawan'.green} => https://www.facebook.com/denny.darmawan.intra n}"
